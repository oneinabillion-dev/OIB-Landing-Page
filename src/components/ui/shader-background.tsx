...
const ShaderBackground = () => {
  ...
  // Fragment shader source code with premium green colors
  const fsSource = `
    ...
    const vec4 lineColor = vec4(0.2314, 0.2314, 0.2314, 1.0);
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.04, 0.12, 0.06, 1.0);
      vec4 bgColor2 = vec4(0.08, 0.20, 0.12, 1.0);
